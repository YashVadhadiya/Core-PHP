...
<script type="text/javascript">
    ...
    {
        var page = ele.value;
        var pageUrl = "<?php echo $this->getUrl('grid','config',['p' => $this->getPager()->getStart()],false) ?>&ppr="+ele.value;
        window.open(pageUrl,"_self");
    }
</script>

<button name="Add"><a href="<?php echo $this->getUrl('add','config',['p' => $this->getPager()->getStart()]) ?>">Add Config</a></button>
            ...
            <?php else: ?>
                <?php foreach($configs as $config): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo$this->getUrl('edit','config',['configId' =>  $config->configId],false) ?>">Edit</a></td>
                        <td><a href="<?php echo$this->getUrl('delete','config',['configId' =>  $config->configId],false) ?>">Delete</a></td>
                    </tr>
                    <?php endforeach; ?>
                        <?php endif; ?>
    </table>