...
<script type="text/javascript">
    ...
    {
        var page = ele.value;
        var pageUrl = "<?php echo $this->getUrl('grid','page',['p' => $this->getPager()->getStart()],false) ?>&ppr="+ele.value;
        window.open(pageUrl,"_self");
    }
</script>

<button name="Add"><a href="<?php echo $this->getUrl('add','page',['p' => $this->getPager()->getEnd()],false) ?>">Add page</a></button>
